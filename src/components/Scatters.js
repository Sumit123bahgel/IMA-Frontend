      ...
      <div style={{ width: '100%' }}>
        <ResponsiveContainer width="100%" height={60}>
          ...
          >
            ...
            <Scatter data={data01} fill="#f76707" />
          </ScatterChart>
        </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height={60}>
          ...
          >
            ...
            <ZAxis type="number" dataKey="value" domain={domain} range={range} />
            <Tooltip cursor={{ strokeDasharray: '3 3' }} wrapperStyle={{ zIndex: 100 }} content={this.renderTooltip} />
            <Scatter data={data02} fill="#0ca678" />
          </ScatterChart>
        </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height={60}>
          ...
          >
            ...
            <ZAxis type="number" dataKey="value" domain={domain} range={range} />
            <Tooltip cursor={{ strokeDasharray: '3 3' }} wrapperStyle={{ zIndex: 100 }} content={this.renderTooltip} />
            <Scatter data={data01} fill="#b197fc" />
          </ScatterChart>
        </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height={60}>
          ...
          >
            ...
            <ZAxis type="number" dataKey="value" domain={domain} range={range} />
            <Tooltip cursor={{ strokeDasharray: '3 3' }} wrapperStyle={{ zIndex: 100 }} content={this.renderTooltip} />
            <Scatter data={data02} fill="#c2255c" />
          </ScatterChart>
        </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height={60}>
          ...
          >
            ...
            <ZAxis type="number" dataKey="value" domain={domain} range={range} />
            <Tooltip cursor={{ strokeDasharray: '3 3' }} wrapperStyle={{ zIndex: 100 }} content={this.renderTooltip} />
            <Scatter data={data01} fill="#74b816" />
          </ScatterChart>
        </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height={60}>
          ...
          >
            ...
            <ZAxis type="number" dataKey="value" domain={domain} range={range} />
            <Tooltip cursor={{ strokeDasharray: '3 3' }} wrapperStyle={{ zIndex: 100 }} content={this.renderTooltip} />
            <Scatter data={data02} fill="#fcc419" />
          </ScatterChart>
        </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height={60}>
          ...
          >
            ...
            <ZAxis type="number" dataKey="value" domain={domain} range={range} />
            <Tooltip cursor={{ strokeDasharray: '3 3' }} wrapperStyle={{ zIndex: 100 }} content={this.renderTooltip} />
            <Scatter data={data01} fill="#38d9a9" />
          </ScatterChart>
        </ResponsiveContainer>
      </div>
    );
